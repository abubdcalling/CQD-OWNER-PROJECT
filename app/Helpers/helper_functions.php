...
function isUnsignedBigInt($value): bool
{
    // Check if the value is numeric and within the unsigned BIGINT range
    if (is_numeric($value) && $value >= 0 && $value <= 18446744073709551615) {
        return true;
    }
    return false;
}
