...
<div class="email-container">
    ...
    <main class="email-body">
        ...
        <p>Once enough clients are grouped for this package, we will notify you and start the service. If you have any questions or would like to modify your application, feel free to contact us at <a href="mailto:<?php echo e($settings['email'] ?? 'support@mail.com'); ?>"><?php echo e($settings['email'] ?? 'support@mail.com'); ?></a>.</p>
        <p>Thank you for choosing <?php echo e($settings['title'] ?? 'COD'); ?>. We look forward to serving you!</p>
        <p>Best regards,</p>
    ...
    <footer class="email-footer">
        ...
        <div class="contact-info">
            ...
            <p>Contact Number: <?php echo e($settings['contact_number'] ?? '+93433434 3433'); ?></p>
        </div>
...
<?php /**PATH /home/customer/www/api.cqdcleaningservices.com/public_html/resources/views/mail/customer-application.blade.php ENDPATH**/ ?>