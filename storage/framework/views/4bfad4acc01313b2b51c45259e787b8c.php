...
<div class="email-container">
    ...
    <main class="email-body">
        ...
        <table>
            ...
            <tr>
                ...
                <td><?php echo e($current_group_size); ?></td>
            </tr>
            <tr>
                <th>Application Date</th>
                <td><?php echo e($application_date); ?></td>
            </tr>
        </table>
    ...
    <footer class="email-footer">
        <p>This is an automated admin notification from <?php echo e($settings['title'] ?? 'COD'); ?>.</p>
        <p>&copy; <?php echo e(date('Y')); ?> <?php echo e($settings['title'] ?? 'COD'); ?>. All rights reserved.</p>
    </footer>
</div>
</body>
</html><?php /**PATH /home/customer/www/api.cqdcleaningservices.com/public_html/resources/views/mail/applicaion-notify-for-admin.blade.php ENDPATH**/ ?>