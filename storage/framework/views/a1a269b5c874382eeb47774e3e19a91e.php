...
<div class="email-container">
    ...
    <main class="email-body">
        <p>Hello there,</p>
        <p>We noticed that you started an application for the <strong><?php echo e($package?->title); ?></strong> package but haven't completed it yet. Don't miss out on the opportunity to join our service group!</p>

        <p>Completing your application only takes a few minutes. Click the button below to pick up where you left off:</p>

        <a href="<?php echo e(env('FRONTEND_APP_URL').'/'.'customer-buy-journey/'.$package?->id); ?>?client=<?php echo e($client_id); ?>" class="cta-button">Complete Your Application</a>

        <p>If you have any questions or need assistance, feel free to reach out to our support team at <a href="mailto:<?php echo e($settings['email'] ?? 'support@mail.com'); ?>"><?php echo e($settings['email'] ?? 'support@mail.com'); ?></a>.</p>
...
</html><?php /**PATH /home/customer/www/api.cqdcleaningservices.com/public_html/resources/views/mail/reminder.blade.php ENDPATH**/ ?>